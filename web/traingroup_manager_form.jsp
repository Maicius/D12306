                            ...
                            <div class="my_top">
                                ...
                                <table>
                                    <tbody class="my_top_tbody">
                                        <tr>
                                            <td><p><input type="text" placeholder="列车编组编号" name=""></p></td>
                                        ...
                                        <tr>
                                            <td><p><input type="text" placeholder="车厢席座类型" name=""></p></td>
                                            <td><p><input type="text" placeholder="车厢席座数量" name=""></p></td>
                                            <td><p><input type="text" placeholder="车厢类型" name=""></p></td>
                    ...
                    <div class="content_result">
                        <table>
                            ...
                            <tr class="th" id="float">
                                <th colspan="1" rowspan="1" ><p>列车编组编号</p></th>
                                <th colspan="1" rowspan="1" ><p>车次代码</p></th>
                                <th colspan="1" rowspan="1" ><p>车厢号</p></th>
                                <th colspan="1" rowspan="1" ><p>车厢席座类型</p></th>
                                <th colspan="1" rowspan="1"><p>车厢席座数量</p></th>
                                <th colspan="1" rowspan="1" ><p>车厢类型</p></th>
