...
<head>
    ...
    <title>欢迎您的光临!</title>
    <style type="text/css">
        /*html{background:url(images/404.png)!important;}*/
        html{background:url(images/404bg.jpg) no-repeat;}
...
<body>
<div id="wrapper">
    <a href="http://www.17sucai.com/"><img class="fade" src="images/404.png"></a>
    <div>
